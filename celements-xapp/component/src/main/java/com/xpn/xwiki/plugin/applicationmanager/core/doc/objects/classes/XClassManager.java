...
public interface XClassManager<T extends XObjectDocument> {
   ...
   * @see #getClassName()
   * @see #getClassSpace()
   * @deprecated since 6.0 instead use getClassDocRef
   */
  @Deprecated
  String getClassFullName();

  /**
   * @return the document reference of the document containing the class. Usually class document
   *         reference is: ClassSpace.ClassName.
   * @see #getClassName()
   * @see #getClassSpace()
   */
  DocumentReference getClassDocRef();
   ...
   * @deprecated since 6.0 instead use getClassTemplateDocRef
   */
  @Deprecated
  String getClassTemplateFullName();

  /**
   * @return the document reference of the document containing the class template. Usually class
   *         template document reference is : ClassTemplateSpace.ClassTemplateName.
   * @see #getClassTemplateSpace()
   * @see #getClassTemplateName()
   */
  ...
  /**
   * @return the full name of the document containing the class sheet. Usually class sheet full name
   *         is :
   ...
   *           error when getting class document from the database.
   */
   ...
   * @throws XWikiException
   *           error when getting class sheet document from the database.
   */
   ...
   * @throws XWikiException
   *           error when getting class template document from the database.
   */
   ...
   * @param validate
   *          indicate if it return new {@link T} or throw exception if wiki descriptor does not
   *          exist.
   * @param context
   *          the XWiki context.
   * @return the document.
   * @throws XWikiException
   *           error when getting document from the database.
   * @see #getItemDefaultName(String)
   * @see #getItemDocumentDefaultFullName(String, XWikiContext)
   ...
   *          the where clause values filled by the method that replace the question marks (?).
   * @return a HQL where clause.
   */
  String createWhereClause(Object[][] fieldDescriptors, List<Object> parameterValues);

  /**
   * Create new super document containing object of class {@link #getClassFullName()}. If document
   * already exist it is
   * returned with new object if it does not contains any.
   *
   * @param doc
   *          the XWiki document to manage.
   * @param objId
   *          the id of the XWiki object included in the document to manage.
   * @param context
   *          the XWiki context.
   ...
   * @throws XWikiException
   *           error when calling T constructor.
   * @future XA2 : rename to newDocumentObject.
   */
   ...
   *
   * @param documents
   *          the list of {@link XWikiDocument}.
   * @param context
   *          the XWiki context.
