...
public class XWikiApplicationClass extends AbstractXClassManager<XWikiApplication> {
  ...
  /**
   * Name of field <code>appname</code> for the XWiki class XAppClasses.XWikiApplicationClass. The
   * unique name of the
   * application.
   */
  ...
  /**
   * Name of field <code>appprettyname</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The displayed
  ...
  /**
   * Name of field <code>description</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The description of
   * the application.
   */
  ...
  /**
   * Name of field <code>version</code> for the XWiki class XAppClasses.XWikiApplicationClass. The
   * version of the
   * application.
   */
  ...
  /**
   * Name of field <code>appauthors</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The description of
   * the application.
   */
  ...
  /**
   * Name of field <code>license</code> for the XWiki class XAppClasses.XWikiApplicationClass. The
   * description of the
   * application.
   */
  ...
  /**
   * Name of field <code>dependencies</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The list of
  ...
  /**
   * Name of field <code>applications</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The list of other
  ...
  /**
   * Name of field <code>documents</code> for the XWiki class XAppClasses.XWikiApplicationClass. The
   * list of documents
  ...
  /**
   * Name of field <code>docstoinclude</code> for the XWiki class XAppClasses.XWikiApplicationClass.
   * The list of
  ...
  /**
   * Name of field <code>docstolink</code> for the XWiki class XAppClasses.XWikiApplicationClass.
  ...
  /**
   * Return unique instance of XWikiApplicationClass and update documents for this context. It also
   * check if the
  ...
  protected boolean updateBaseClass(BaseClass baseClass) {
    ...
    needsUpdate |= baseClass.addStaticListField(FIELD_DEPENDENCIES, FIELDPN_DEPENDENCIES, 80, true,
        "", DEFAULT_FIELDDT,
        DEFAULT_FIELDS);

    needsUpdate |= baseClass.addStaticListField(FIELD_APPLICATIONS, FIELDPN_APPLICATIONS, 80, true,
        "", DEFAULT_FIELDDT,
        DEFAULT_FIELDS);

    needsUpdate |= baseClass.addStaticListField(FIELD_DOCUMENTS, FIELDPN_DOCUMENTS, 80, true, "",
        DEFAULT_FIELDDT,
        DEFAULT_FIELDS);

    needsUpdate |= baseClass.addStaticListField(FIELD_DOCSTOINCLUDE, FIELDPN_DOCSTOINCLUDE, 80,
        true, "", DEFAULT_FIELDDT,
        DEFAULT_FIELDS);

    needsUpdate |= baseClass.addStaticListField(FIELD_DOCSTOLINK, FIELDPN_DOCSTOLINK, 80, true, "",
        DEFAULT_FIELDDT,
        DEFAULT_FIELDS);

    needsUpdate |= baseClass.addStaticListField(FIELD_TRANSLATIONDOCS, FIELDPN_TRANSLATIONDOCS, 80,
        true, "", DEFAULT_FIELDDT,
        DEFAULT_FIELDS);
  ...
  /**
   * Get the XWiki document descriptor of containing XAppClasses.XWikiApplication XWiki object with
   * "appname" field
   ...
   *          the XWiki context.
   * @param validate
   *          indicate if it return new {@link XWikiDocument} or throw exception if application
   *          descriptor does
   *          not exist.
   * @return the {@link XWikiDocument} representing application descriptor.
   * @throws XWikiException
   *           error when searching for application descriptor document.
  ...
  protected XWikiDocument getApplicationDocument(String appName, XWikiContext context,
    ...
    String[][] fieldDescriptors = new String[][] {
        { FIELD_APPNAME, StringProperty.class.getSimpleName(), appName } };
    List<Object> parameterValues = new ArrayList<>();
    String where = createWhereClause(fieldDescriptors, parameterValues);

    List<XWikiDocument> listApp = context.getWiki().getStore().searchDocuments(where,
   ...
   *          the XWiki context.
   * @param validate
   *          indicate if it return new XWikiDocument or throw exception if application descriptor
   *          does not
   *          exist.
