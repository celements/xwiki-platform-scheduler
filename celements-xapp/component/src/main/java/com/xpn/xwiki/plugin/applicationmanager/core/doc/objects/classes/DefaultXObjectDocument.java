 ...
 * provided XWiki class. It
 * add some specifics methods, getters and setters for this type of object and fields. It also
 * override {@link Document}
 * (and then {@link XWikiDocument}) isNew concept considering as new a document that does not
 * contains an XWiki object
...
public class DefaultXObjectDocument extends Document implements XObjectDocument {
   ...
   *          the class manager for this document.
   * @param xdoc
   *          the XWikiDocument to manage.
   * @param objectId
   *          the id of the XWiki object included in the document to manage.
   * @param context
   *          the XWiki context.
   * @throws XWikiException
   *           error when calling {@link #reload(XWikiContext)}.
   */
  public DefaultXObjectDocument(XClassManager<? extends XObjectDocument> sclass, XWikiDocument xdoc,
      int objectId, XWikiContext context) throws XWikiException {
    super(xdoc, context);
    this.modelAccess = Utils.getComponent(IModelAccessFacade.class);
  ...
  /**
   * @param docFullName
   *          modify the full name the the managed XWikiDocument.
   */
  ...
  public void reload(XWikiContext context) throws XWikiException {
    if (this.getObjectNumbers(this.sclass.getClassFullName()) == 0) {
      ...
      BaseObject object = getDoc().newXObject(this.sclass.getClassDocRef(), context);
   ...
   *
   * @param toWrite
   *          indicate that the {@link BaseObject} will be modified.
   ...
   *
   * @param fieldName
   *          the name of the field from the managed object's class where to find the value.
   * @return the value in {@link String} of the field <code>fieldName</code> of the managed object's
   *         class.
   ...
   * <p>
   * This method makes sure the right property type between LargeStringProperty and StringProperty
   * is used.
   *
   * @param fieldName
   *          the name of the field from the managed object's class where to find the value.
   * @param value
   *          the new value of the field <code>fieldName</code> of the managed object's class.
   ...
   *         class.
   * @see com.xpn.xwiki.doc.XWikiDocument#getStringValue(java.lang.String)
   * @deprecated Use {@link #getStringValue(String)} which support LargeStringProperty and
   *             StringProperty.
   */
  @Deprecated
   ...
   * @deprecated Use {@link #setStringValue(String, String)} which support LargeStringProperty and
   *             StringProperty.
   */
  @Deprecated
   ...
   * @param fieldName
   *          the name of the field from the managed object's class where to find the value.
   * @return the value in {@link List} of the field <code>fieldName</code> of the managed object's
   *         class.
  ...
  public Boolean getBooleanValue(String fieldName) {
    ...
    return intValue == BOOLEANFIELD_TRUE ? Boolean.TRUE
        : (intValue == BOOLEANFIELD_FALSE ? Boolean.FALSE : null);
  }
  ...
  public void setBooleanValue(String fieldName, Boolean value) {
    setIntValue(fieldName,
        value == null ? BOOLEANFIELD_MAYBE
            : (value ? BOOLEANFIELD_TRUE
                : BOOLEANFIELD_FALSE));
  }
}
